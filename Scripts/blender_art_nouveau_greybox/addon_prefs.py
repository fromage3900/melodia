...
class MELNOUVEAU_Preferences(AddonPreferences):
    bl_idname = __package__

    export_directory: StringProperty(
        name="UE5 Export Directory",
        description="Default directory for FBX export",
        subtype='DIR_PATH',
        default="",
    )
    ...
    unit_scale: FloatProperty(
        name="Unit Scale",
        description="Scale factor for FBX export (0.01 = Blender units to UE5 cm)",
        default=0.01,
        min=0.001,
        max=1.0,
        precision=4,
    ...
    default_mode: EnumProperty(
        ...
        items=[
            ...
            ('IMPOSSIBLE', "Impossible", "Non-manifold, overlapping geometry"),
        ],
        default='VALID',
    )
...
_classes = [MELNOUVEAU_Preferences]
