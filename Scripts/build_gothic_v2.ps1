...
function Build-SDF($name, $paramDefs, $hlslCode, $inputNames) {
    ...
    # Step 2: Create Custom HLSL node
    ...
    # Step 3: Get expressions with retry
...
Write-Host "`n=== GOTHIC BATCH 1 COMPLETE ===" -ForegroundColor Green
